...
const Contact = () => {
    return (
        <section className="seccion-contacto" id="seccion-contacto">
            <div className="container text-center">
                <h1 className="pt-1 fs-2 border-bottom border-3">Déjanos tu <span className="text-primary">Mensaje</span>.</h1>
            </div>
